<?php
include("admin/admin_ins/db.php");
?>
<!DOCTYPE html>
<html lang="zxx">
 ...
 ?>
                        ...
                        <div class="col-xs-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
                                ...
                                <div class="card" >
                    <img style="width:100%; height:200px"  class="card-img-top" src="admin/prod_img/<?php  echo $row['image']?>"  >
                    <div class="card-body">
                    <h4 class="card-title"><?php echo $row['name'] ?></h4>
                    <p class="card-text"><?php echo $row['price'] ?></p>
                    <button data-toggle="modal" data-target="#myModal<?php echo $row['id'] ?>" class="btn btn-primary">Read More</button>
					<button  data-toggle="modal" data-target="#buy<?php echo $row['id'] ?>"class="btn btn-success">Buy Now</button>
                    </div>
                    </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
						...
						<div class="modal" id="buy<?php echo $row['id'] ?>">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="ins_order.php" method="post">
			...
			<p><input class="btn btn-success" type="submit" name="save" value="Buy Now"/></p>
		</form>
      </div>
